        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <aside className="space-y-4">
            <div className="rounded-2xl border border-[color:var(--color-input-border)] bg-[color:var(--card-bg)] p-6 space-y-4 shadow-[var(--shadow-soft)]">
              <div>
                <p className="text-xs font-semibold text-[color:var(--color-muted)] uppercase tracking-widest">Precio desde</p>
                <p className="text-5xl font-black text-[color:var(--color-text)] mt-2">${pkg.price}</p>
                <p className="text-sm text-[color:var(--color-accent)] mt-2 font-semibold">Adelanto 50% para confirmar</p>
              </div>
              <div className="space-y-3 text-sm border-t border-[color:var(--color-input-border)] pt-3">
                <div className="flex items-center justify-between">
                  <span className="text-[color:var(--color-muted)] font-semibold">Capacidad</span>
                  <span className="text-[color:var(--color-text)] font-bold">{pkg.maxPeople} personas</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-[color:var(--color-muted)] font-semibold">Categoría</span>
                  <span className="text-[color:var(--color-text)] font-bold">{pkg.category}</span>
                </div>
              </div>
              <Button
                variant="primary"
              ...
              <p className="text-sm text-[color:var(--color-muted)] leading-relaxed">Podrás elegir fecha, extras y confirmar tu anticipo en el siguiente paso.</p>
            </div>
