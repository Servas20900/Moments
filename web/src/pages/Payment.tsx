  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      if (res?.ok) {
        ...
        setInvoiceNumber(res.numeroFactura ?? null)
        const trackingNumber = res.numeroFactura || res.id
        ...
        if (contact.paymentMethod === 'SINPE') {
          ...
          alert(`Reserva creada. Factura: ${trackingNumber}. Redirección a CompraClick pendiente de implementar.`)
          ...
          <div className="rounded-xl border border-green-500/30 bg-green-500/10 p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-200">Número de factura: <span className="font-mono font-bold">{invoiceNumber || reservationId}</span></p>
              </div>
            </div>
          </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-300 mt-1">
                    Toma una captura de pantalla del comprobante y envíala al correo <a href={`mailto:pagos@moments.cr?subject=Comprobante Factura ${invoiceNumber || reservationId}`} className="text-amber-300 underline">pagos@moments.cr</a>
                  </p>
                  <p className="text-xs text-gray-400 mt-2">Asunto: Comprobante Factura {invoiceNumber || reservationId}</p>
                </div>
              </div>
