      ...
      <Section spacing="lg">
        <div className="flex items-center justify-between flex-wrap gap-3 mb-4">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-300">
            ...
            <span className="inline-flex items-center gap-2 rounded-full bg-violet-900/40 border border-violet-400/30 px-3 py-1 text-xs font-semibold text-violet-100">{vehicle.quantity} unidad{vehicle.quantity !== 1 ? 'es' : ''}</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <div className="rounded-xl border border-white/10 bg-white/5 px-4 py-3">
                  ...
                  <p className="text-lg font-semibold text-violet-200">{vehicle.quantity}</p>
                </div>
              </div>
          ...
          <aside className="space-y-4">
            <div className="rounded-2xl border border-[color:var(--color-input-border)] bg-[color:var(--card-bg)] p-6 space-y-4 shadow-[var(--shadow-soft)]">
              <div>
                <p className="text-xs font-semibold text-[color:var(--color-muted)] uppercase tracking-widest">Resumen</p>
                <p className="text-base text-[color:var(--color-text)] mt-2 font-semibold">Vehículo disponible para reservar dentro de paquetes activos.</p>
              </div>
              <div className="space-y-3 text-sm border-t border-[color:var(--color-input-border)] pt-3">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-[color:var(--color-muted)] font-semibold">Unidades</span>
                  <span className="text-[color:var(--color-text)] font-bold">{vehicle.quantity}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-[color:var(--color-muted)] font-semibold">Costo del vehículo</span>
                  <span className="text-emerald-200 font-bold">Incluido en paquete</span>
                </div>
              </div>
              <Button
                variant="primary"
              ...
              <p className="text-sm text-[color:var(--color-muted)] leading-relaxed">Elige este vehículo dentro de un paquete y personaliza tu experiencia.</p>
            </div>
