import { IsEmail, IsInt, IsOptional, IsString, MinLength, Matches } from 'class-validator';
...
export class RegisterDto {
  ...
  @ApiProperty({ 
    example: 'Password123!',
    description: 'Contraseña (mínimo 6 caracteres, debe incluir letras, números y símbolos)'
  })
  @IsString()
