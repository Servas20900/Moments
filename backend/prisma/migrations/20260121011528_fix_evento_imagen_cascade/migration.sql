...
-- DropForeignKey
ALTER TABLE "imagenes_eventos" DROP CONSTRAINT "imagenes_eventos_eventoId_fkey";
...
-- AddForeignKey
ALTER TABLE "imagenes_eventos" ADD CONSTRAINT "imagenes_eventos_eventoId_fkey" FOREIGN KEY ("eventoId") REFERENCES "eventos_calendario"("id") ON DELETE CASCADE ON UPDATE CASCADE;
